...
{
    rt_kprintf("\r\r\r\n \\ | /\r\r\r\n");
    rt_kprintf("- RT -     Thread Operating System\r\r\r\n");
    rt_kprintf(" / | \\     %d.%d.%d build %s\r\r\r\n",
               RT_VERSION, RT_SUBVERSION, RT_REVISION, __DATE__);
    rt_kprintf(" 2006 - 2015 Copyright by rt-thread team\r\r\r\n");
}
...
#endif
		{
	        rt_kprintf("(%s) assertion failed at function:%s, line number:%d \r\r\r\n", ex_string, func, line);
	        while (dummy == 0);
		}
    }
	else
