...
void rt_timer_check(void)
{
    ...
    RT_DEBUG_LOG(RT_DEBUG_TIMER, ("timer check enter\r\r\n"));
    ...
    while (!rt_list_isempty(&rt_timer_list[RT_TIMER_SKIP_LIST_LEVEL-1]))
    {
        ...
        if ((current_tick - t->timeout_tick) < RT_TICK_MAX/2)
        {
            ...
            RT_DEBUG_LOG(RT_DEBUG_TIMER, ("current tick: %d\r\r\n", current_tick));
    ...
    RT_DEBUG_LOG(RT_DEBUG_TIMER, ("timer check leave\r\r\n"));
}
...
void rt_soft_timer_check(void)
{
    ...
    RT_DEBUG_LOG(RT_DEBUG_TIMER, ("software timer check enter\r\r\n"));
    ...
    RT_DEBUG_LOG(RT_DEBUG_TIMER, ("software timer check leave\r\r\n"));
}
