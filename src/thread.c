...
rt_err_t rt_thread_startup(rt_thread_t thread)
{
    ...
    RT_DEBUG_LOG(RT_DEBUG_THREAD, ("startup a thread:%s with priority:%d\r\r\n",
...
rt_err_t rt_thread_suspend(rt_thread_t thread)
{
    ...
    RT_DEBUG_LOG(RT_DEBUG_THREAD, ("thread suspend:  %s\r\r\n", thread->name));

    if (thread->stat != RT_THREAD_READY)
    {
        RT_DEBUG_LOG(RT_DEBUG_THREAD, ("thread suspend: thread disorder, %d\r\r\n",
                                       thread->stat));
...
rt_err_t rt_thread_resume(rt_thread_t thread)
{
    ...
    RT_DEBUG_LOG(RT_DEBUG_THREAD, ("thread resume:  %s\r\r\n", thread->name));

    if (thread->stat != RT_THREAD_SUSPEND)
    {
        RT_DEBUG_LOG(RT_DEBUG_THREAD, ("thread resume: thread disorder, %d\r\r\n",
                                       thread->stat));
